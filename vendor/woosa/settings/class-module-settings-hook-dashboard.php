...
class Module_Settings_Hook_Dashboard implements Interface_Hook_Settings_Section{
   ...
   public static function add_section_fields($items) {
      ...
      $items[] = [
         'name' => __('Settings', 'woosa-ai-for-woocommerce'),
         'id'   => Util::prefix('settings_start'),
         'type' => 'title',
      ];

      $items[] = [
         'name'  => __('Debug mode', 'woosa-ai-for-woocommerce'),
         'id'    => Util::prefix('debug'),
         'type'  => 'toggle',
         'desc'  => __('Enable this if you want to see advanced logs.', 'woosa-ai-for-woocommerce'),
         'value' => Option::get('debug', 'no'),
      ];

      $items[] = [
         'name'  => __('Remove configuration', 'woosa-ai-for-woocommerce'),
         'id'    => Util::prefix('remove_config'),
         'type'  => 'toggle',
         'desc'  => __('Enable this if you want to remove the plugin configuration when is uninstalled.', 'woosa-ai-for-woocommerce'),
