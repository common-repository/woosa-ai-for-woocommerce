...
$periods      = array(
   'days'   => __( 'Day(s)', 'woosa-ai-for-woocommerce' ),
   'weeks'  => __( 'Week(s)', 'woosa-ai-for-woocommerce' ),
   'months' => __( 'Month(s)', 'woosa-ai-for-woocommerce' ),
   'years'  => __( 'Year(s)', 'woosa-ai-for-woocommerce' ),
);
