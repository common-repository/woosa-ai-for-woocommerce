...
class Module_Authorization_Hook_Settings implements Interface_Hook_Settings_Tab{
   ...
   public static function name(){
      return __('Authorization', 'woosa-ai-for-woocommerce');
   }
   ...
   public static function description(){
      return apply_filters(PREFIX . '\module\authorization\settings_tab_description', sprintf(__('Connect %s account', 'woosa-ai-for-woocommerce'), SETTINGS_TAB_NAME));
   }
   ...
   public static function add_tab_fields(array $items){
      ...
      $items = array_merge([
         [
            'name' => sprintf(
               __('%s Account', 'woosa-ai-for-woocommerce'),
               SETTINGS_TAB_NAME
            ),
